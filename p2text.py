...
class Ws_Param(object):
    ...
    def __init__(self, APPID, APIKey, APISecret, AudioFile):
        ...
        self.BusinessArgs = {"domain": "iat", "language": "en_us", "vinfo":1}
...
def process_audio_file(audio_file_path):
    global wsParam ,global_result  # 声明 wsParam 为全局变量
    global_result = ""
    time1 = datetime.now()
...
if __name__ == "__main__":
    # 测试时候在此处正确填写相关信息即可运行
    process_audio_file(r'./recording_en_pcn.wav')
    # process_audio_file(r'./recording_1.wav')
